    ...
    <div id="user-profile">
            ...
            <div class="col-9 ms-5">
                <div class="card profile-header mb-2">
                    ...
                    <div style="border-radius: 50px;"> <img class="card-img-top" style="border-radius: 8px;"
                            src="/vuexy_assets/app-assets/images/profile/user-uploads/timeline.jpg"
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row mt-1">
                            ...
                            <div class="col-md-4 col-6 profile-latest-img" style="padding:3px;">
                    ...
                    <div class="card-body" style="padding-bottom: 0;">
                        <div class="d-flex justify-content-start align-items-center mb-1">
                            ...
                            <div class="avatar me-1">
                                <img alt="avatar img" height="40" width="40" />
                            </div>
                            <!--/ avatar -->
                            <div class="profile-user-info">
                                <h6 class="mb-0"><b>Minh Tuan</b>
                                </h6>
                                <small class="text">sdsdsd</small>
                            </div>
                        </div>
                        <div class="card-text">
                        ...
                        <!-- post img -->
                        <img class="img-fluid rounded mb-75" style="width: 100%; height: 350px; background-size: cover"
                            alt="avatar img" />
        ...
        <div class="modal fade text-start" id="showImg" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="d-flex mt-1">
                        <h3 class="modal-title" style="margin: auto"><b>Album</b></h3>
                    </div>
                    <div class="dropdown-divider mt-1"></div>
                    <div class="modal-body d-flex">
                        <img src="/vuexy_assets/app-assets/images/profile/user-uploads/user-13.jpg"
                            class="img-fluid rounded" style="width: 400px; margin: auto;" />
                    </div>
                </div>
