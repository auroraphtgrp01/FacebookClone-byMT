                                        ...
                                        <div class="row">
                                            ...
                                            <ul class="d-flex button-group--status">
                                                <li class="btn button_list-item d-flex">
                                                    ...
                                                    <b class="ms-1 button_label"
                                                        style="font-size: 0.8rem;margin-top: 4px;">Video
                                                        Trực Tiếp</b>
                                                </li>
                                                <li class="btn button_list-item d-flex">
                                                    <img height="24" width="24" alt=""
                                                    ...
                                                    <b class="ms-1 button_label"
                                                        style="font-size: 0.8rem;margin-top: 4px;">Ảnh
                                                        /
                                                        Video</b>
                                                </li>
                                                <li class="btn button_list-item d-flex">
                                                    ...
                                                    <b class="ms-1 button_label"
                                                        style="font-size: 0.8rem;margin-top: 4px;">Cảm
                                                        xúc
                                                        / Hoạt động</b>
                                                </li>
                                            </ul>
                                                ...
                                                <ul class="list-react__button d-flex">
                                                    <template v-if="v.like_status == 0">
                                                        <li v-on:click="changeReact(v)"
                                                            ...
                                                            <b class="ms-1 text-react text-primary"
