<nav class="header-navbar navbar-expand-lg navbar navbar-fixed align-items-center navbar-shadow navbar-brand-center d-flex"
    ...
    {{-- <div class="navbar-header d-xl-block d-none text-center">
        ...
        <div class="col-md-3">
            <ul class="nav navbar-nav align-items-center" style="justify-content: flex-end">
                <li class="nav-item dropdown dropdown-notification me-25 me-1">
                    ...
                    <button class="btn btn-notify" style="padding: 0;" data-bs-toggle="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-media dropdown-menu-end">
                        ...
                        <li class="scrollable-container media-list"><a class="d-flex" href="#">
                                ...
                                <div class="list-item d-flex align-items-start">
                                    <div class="me-1">
                                        <div class="avatar"><img
                                                src="/vuexy_assets/app-assets/images/portrait/small/avatar-s-3.jpg"
                                                alt="avatar" width="32" height="32"></div>
                                    </div>
                                    <div class="list-item-body flex-grow-1">
                                        <p class="media-heading"><span class="fw-bolder">New
                                                message</span>&nbsp;received
